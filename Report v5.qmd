...
The 5% Value at Risk on 1 month positions in the crack spread is `r VAR`. This does not count for liquidity risk day to day, but gives us a sense of how much we can lose entering long today and exiting in a month from now. VAR indicates more tail risk on short positions than long positions. A more detailed visual is below:
...
To get a sense of the chances of getting closed out early due to daily volatility (liquidity risk), we can observe the 20 and 50 day rolling volatility for crack spread below:
