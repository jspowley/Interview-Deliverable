...
tonnage_model <- auto_forecast(fred_data, "Truck_Tonnage_Index", 365/12, F)
...
# crude_prod_model <- auto_forecast(fundamentals_data, "US_Crude_Prod", 365/12, T)
# In prior review, crude production tracks with GDP growth. With this in mind, I filtered out to just post 2020 data to remove the level shift in 2020.
  
crude_prod_stl <- fundamentals_data %>% autoSTL(series_name = "US_Crude_Prod", 365/12, 12, 13, T)
crude_prod_arma <- crude_prod_stl$arima_ready %>% auto_forecast()
```
