...
```{r}
# Un-comment lines to see full outputs, helpful for analysts trying to choose an appropriate model.

crude_inv_model <- auto_forecast(fundamentals_data, "US_Crude_Inventory", 7)
# Integrated model (p,d,q) = (2,1,3)
