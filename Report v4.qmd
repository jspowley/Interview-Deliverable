...
```{r, aggregation, model_prep, echo = F}
...
```{r, demonstrational_graphics, echo = F}
...
```{r, generalized forecasting function, echo = F}
...
With no reversals between dependendent and independent variables, our model forecasts an upside potential of `r abs(current_price - forecast_prediction)` per barrel.
